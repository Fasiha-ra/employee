  ...
  const handleSubmit = async (e) => {
    ...
    try {
     if(profileImage){
      ...
      const imgResponse =await axios.post(`${serverDomain}/upload`,imageData, {
        headers: {
      ...
      const res = await axios.put(`${serverDomain}/user/3`, formData, {
        headers: {
            ...
            <div className="profleHolder">
              <div className="profile">
                ...
                {!formData?.avatar ? (
                  ...
                  <img src={`${serverDomain }/${formData?.avatar ? formData?.avatar : URL.createObjectURL(profileImage)}`} alt="profile" />
                )}
              </div>
